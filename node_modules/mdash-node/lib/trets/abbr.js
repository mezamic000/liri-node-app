  ...
  module.exports = Abbr = (function(_super) {
    ...
    Abbr.prototype.rules = {
      ...
      ps_pps: {
        ...
        replacement: [
          function($) {
            return $[1] + Lib.tag(("" + ($[2].trim()) + " ") + ($[3] != null ? "" + ($[3].trim()) + " " : "") + $[4], "nobr") + $[5];
          }
        ]
      },
      nobr_vtch_itd_itp: {
      ...
      nbsp_money_abbr: {
        ...
        replacement: [
          function($) {
            return $[1] + ($[4] != null ? ("&nbsp;" + $[4]) + ($[4] === "тыс" ? "." : "") : "") + "&nbsp;" + (!$[7].match(/у[\\\\.]? ?е[\\\\.]?/gi) ? $[7] : "у.е.");
          }
        ]
      },
      nbsp_org_abbr: {
      ...
      nobr_gost: {
        pattern: [/(\s|\&nbsp\;|^)ГОСТ( |\&nbsp\;)?(\d+\.?\d*)((\-|\&minus\;|\&mdash\;)(\d+))?(( |\&nbsp\;)(\-|\&mdash\;))?/ig, /(\s|\&nbsp\;|^|\>)ГОСТ( |\&nbsp\;)?(\d+\.?\d*)(\-|\&minus\;|\&mdash\;)(\d+)/ig, /(\b)(LVS(\s|\&nbsp\;)?[A-Z]{0,2})(\s|\&nbsp\;)?(\d+)(\:|\-|\&minus\;|\&mdash\;|)(\d+)/ig, /(\b)(RFC|ISO|IEEE)( |\&nbsp\;)?(\d+[\.\-\/\:]?\d*)/ig],
        replacement: [
          function($) {
            return $[1] + Lib.tag(("ГОСТ " + $[3]) + ($[6] != null ? "&ndash;" + $[6] : "") + ($[7] != null ? " &mdash;" : ""), "nobr");
          }, function($) {
            return "" + $[1] + "ГОСТ " + $[3] + "&ndash;" + $[5];
          }, function($) {
            return $[1] + Lib.tag("" + ($[2].trim()) + " " + $[5] + ":" + $[7], "nobr");
          }, function($) {
