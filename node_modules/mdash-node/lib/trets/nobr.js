  ...
  module.exports = Nobr = (function(_super) {
    ...
    Nobr.prototype.rules = {
      super_nbsp: {
        ...
        replacement: [
          function($) {
            return ("" + $[1] + ($[3].trim()) + "&nbsp;") + ($[4] != null ? ("" + $[4]).trim() + "&nbsp;" : "") + $[5];
          }
        ]
      },
      nbsp_in_the_end: {
      ...
      phone_builder: {
        pattern: [/([^\d\+]|^)([\+]?[0-9]{1,3})(\s|\&nbsp\;|\&thinsp\;)([0-9]{1,4}|\([0-9]{3,4}\))?(\s|\&nbsp\;|\&thinsp\;)?([0-9]{2,3})?(\s|\&nbsp\;|\&thinsp\;|-|\&minus\;)?([0-9]{2,3})(\s|\&nbsp\;|\&thinsp\;|-|\&minus\;)([0-9]{2,4})([^\d]|$)/g],
        replacement: [
          function($) {
            var number, sep, thinsp, _ref, _ref1;
            thinsp = " ";
            sep = (_ref = $[9]) === "-" || _ref === "&minus;" ? "-" : thinsp;
            number = "" + $[2] + thinsp + $[4] + thinsp + $[6] + sep + $[8] + sep + $[10];
            return $[1] + ((_ref1 = $[1]) === ">" || _ref1 === "<" ? number : Lib.tag(number, "nobr")) + $[1];
          }
        ]
      },
      ip_address: {
      ...
      nbsp_celcius: {
        pattern: [/(\B)(\d+)( |\&nbsp\;)?(°|\&deg\;)(C|С)(\s|\.|\!|\?|\,|$|\&nbsp\;|\;)/ig],
        replacement: [
          function($) {
            return "" + $[1] + $[2] + "&nbsp;" + $[4] + "C" + $[6];
          }
      ...
      hyphen_nowrap_in_small_words: {
        pattern: [/(\B)([a-zа-яё]{1}\-[a-zа-яё]{4}|[a-zа-яё]{2}\-[a-zа-яё]{3}|[a-zа-яё]{3}\-[a-zа-яё]{2}|[a-zа-яё]{4}\-[a-zа-яё]{1}|когда\-то|кое\-как|кой\-кого|вс[её]\-таки|[а-яё]+\-(кась|ка|де))(\s|\.|\,|\!|\?|\&nbsp\;|\&hellip\;|$)/gi],
        replacement: [
          function($) {
