(function() {
  var INTERNAL_BLOCK_CLOSE, INTERNAL_BLOCK_OPEN, LAYOUT_CLASS, LAYOUT_STYLE, __charsTable, __classes, __htmlCharEnts, __stripTags,
  ...
  exports.styles = function(list) {
    var classname, css, k, res, style, v;
    if (list == null) {
      list = false;
    }
    res = {};
  ...
  exports.convertEntitiesToUnicode = function(text) {
    ...
    text = text.replace(/\&([a-zA-Z0-9]+)\;/g, function(match, m) {
      var r;
      if (__htmlCharEnts[m] != null) {
        r = String.fromCharCode(__htmlCharEnts[m]);
      }
      return r || match;
    });
    return text;
